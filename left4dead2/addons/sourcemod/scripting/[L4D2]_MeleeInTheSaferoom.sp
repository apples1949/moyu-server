...
public OnPluginStart()
{
	...
	CreateConVar( "l4d2_MITSR_Version",		VERSION, "The version of Melee In The Saferoom", FCVAR_NONE ); 
	g_hEnabled				    = CreateConVar( "l4d2_MITSR_Enabled",			"1", "Should the plugin be enabled", FCVAR_NONE ); 
	g_hWeaponRandom			    = CreateConVar( "l4d2_MITSR_Random",			"1", "Spawn Random Weapons (1) or custom list (0)", FCVAR_NONE ); 
	g_hWeaponRandomAmount	    = CreateConVar( "l4d2_MITSR_Amount",			"8", "Number of weapons to spawn if l4d2_MITSR_Random is 1", FCVAR_NONE ); 
	g_hWeaponBaseballbat	    = CreateConVar( "l4d2_MITSR_Baseballbat",		"1", "Number of baseball bats to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponCricketbat	        = CreateConVar( "l4d2_MITSR_Cricketbat",		"1", "Number of cricket bats to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponCrowbar	        = CreateConVar( "l4d2_MITSR_Crowbar",			"1", "Number of crowbars to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponElectricguitar	    = CreateConVar( "l4d2_MITSR_Electricguitar",	"1", "Number of electric guitars to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponFireaxe	        = CreateConVar( "l4d2_MITSR_Fireaxe",			"1", "Number of fire axes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponFryingpan	        = CreateConVar( "l4d2_MITSR_Fryingpan",			"1", "Number of frying pans to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponGolfclub	        = CreateConVar( "l4d2_MITSR_Golfclub",			"1", "Number of golf clubs to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponKatana	            = CreateConVar( "l4d2_MITSR_Katana",			"1", "Number of katanas to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponMachete	        = CreateConVar( "l4d2_MITSR_Machete",			"1", "Number of machetes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponTonfa	            = CreateConVar( "l4d2_MITSR_Tonfa",				"1", "Number of nightsticks to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeapon2handedconcrete	= CreateConVar( "l4d2_MITSR_2handedconcrete",	"1", "Number of large concrete sticks to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponAetherpickaxe		= CreateConVar( "l4d2_MITSR_Aetherpickaxe",		"1", "Number of aether pickaxes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponAethersword		= CreateConVar( "l4d2_MITSR_Aethersword",		"1", "Number of aether swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponArm			    = CreateConVar( "l4d2_MITSR_Arm",				"1", "Number of arms to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponBrokenbottle		= CreateConVar( "l4d2_MITSR_Brokenbottle",		"1", "Number of brown broken bottles to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponFoamfinger			= CreateConVar( "l4d2_MITSR_Foamfinger",		"1", "Number of foam fingers to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponLegbone			= CreateConVar( "l4d2_MITSR_Legbone",			"1", "Number of leg bones to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponBamboo			    = CreateConVar( "l4d2_MITSR_Bamboo",			"1", "Number of bamboo sticks to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponBarnacle			= CreateConVar( "l4d2_MITSR_Barnacle",			"1", "Number of barnacle guns to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponBigoronsword		= CreateConVar( "l4d2_MITSR_Bigoronsword",		"1", "Number of biggoron swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponBnc			    = CreateConVar( "l4d2_MITSR_Bnc",				"1", "Number of flails to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponBottle			    = CreateConVar( "l4d2_MITSR_Bottle",			"1", "Number of green broken bottles to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponBow			    = CreateConVar( "l4d2_MITSR_Bow",				"1", "Number of recurve bows to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponNail			    = CreateConVar( "l4d2_MITSR_Nail",				"1", "Number of pain trains to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponSledge			    = CreateConVar( "l4d2_MITSR_Sledge",			"1", "Number of homewreckers to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponTorch			    = CreateConVar( "l4d2_MITSR_Torch",				"1", "Number of skull torches to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponChains			    = CreateConVar( "l4d2_MITSR_Chains",			"1", "Number of chains to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponChair			    = CreateConVar( "l4d2_MITSR_Chair",				"1", "Number of classroom chairs to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponChair2			    = CreateConVar( "l4d2_MITSR_Chair2",			"1", "Number of wooden chairs to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponCombatknife		= CreateConVar( "l4d2_MITSR_CombatKnife",		"1", "Number of combat knives to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponComputerkeyboard	= CreateConVar( "l4d2_MITSR_ComputerKeyboard",	"1", "Number of computer keyboards to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponConcrete1			= CreateConVar( "l4d2_MITSR_Concrete1",			"1", "Number of medium concrete sticks to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponConcrete2			= CreateConVar( "l4d2_MITSR_Concrete2",			"1", "Number of small concrete sticks to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponCustomammopack		= CreateConVar( "l4d2_MITSR_Customammopack",	"1", "Number of deployable ammo packs to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponDaxe			    = CreateConVar( "l4d2_MITSR_Daxe",				"1", "Number of battleaxes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponDekustick			= CreateConVar( "l4d2_MITSR_Dekustick",			"1", "Number of deku sticks to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponDhoe			    = CreateConVar( "l4d2_MITSR_Dhoe",				"1", "Number of diamond hoes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponDoc1			    = CreateConVar( "l4d2_MITSR_Doc1",				"1", "Number of kink maps to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponDshovel			= CreateConVar( "l4d2_MITSR_Dshovel",			"1", "Number of diamond shovels to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponDsword			    = CreateConVar( "l4d2_MITSR_Dsword",			"1", "Number of diamond swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponDustpan			= CreateConVar( "l4d2_MITSR_Dustpan",			"1", "Number of dustpans and brushes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponElectricguitar2	= CreateConVar( "l4d2_MITSR_Electricguitar2",	"1", "Number of black guitars to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponElectricguitar3	= CreateConVar( "l4d2_MITSR_Electricguitar3",	"1", "Number of orange guitars to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponElectricguitar4	= CreateConVar( "l4d2_MITSR_Electricguitar4",	"1", "Number of grey guitars to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponEnchsword			= CreateConVar( "l4d2_MITSR_Enchsword",			"1", "Number of enchanted swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponFishingrod			= CreateConVar( "l4d2_MITSR_Fishingrod",		"1", "Number of fishing rods to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponFlamethrower		= CreateConVar( "l4d2_MITSR_Flamethrower",		"1", "Number of makeshift flamethrowers to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponFoot			    = CreateConVar( "l4d2_MITSR_Foot",				"1", "Number of feet to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponFubar			    = CreateConVar( "l4d2_MITSR_Fubar",				"1", "Number of fubars to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponGaxe			    = CreateConVar( "l4d2_MITSR_Gaxe",				"1", "Number of golden axes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponGhoe			    = CreateConVar( "l4d2_MITSR_Ghoe",				"1", "Number of golden hoes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponGloves			    = CreateConVar( "l4d2_MITSR_Gloves",			"1", "Number of boxing gloves to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponGman			    = CreateConVar( "l4d2_MITSR_Gman",				"1", "Number of garbage sets to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponGpickaxe			= CreateConVar( "l4d2_MITSR_Gpickaxe",			"1", "Number of golden pickaxes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponGshovel			= CreateConVar( "l4d2_MITSR_Gshovel",			"1", "Number of golden shovels to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponGuandao			= CreateConVar( "l4d2_MITSR_Guandao",			"1", "Number of guandaos to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponGuitar			    = CreateConVar( "l4d2_MITSR_Guitar",			"1", "Number of black electric guitars to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponHammer			    = CreateConVar( "l4d2_MITSR_Hammer",			"1", "Number of mega hammers to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponHelmsanduril		= CreateConVar( "l4d2_MITSR_Helmsanduril",		"1", "Number of andurils to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponHelmshatchet		= CreateConVar( "l4d2_MITSR_Helmshatchet",		"1", "Number of hatchets to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponHelmsorcrist		= CreateConVar( "l4d2_MITSR_Helmsorcrist",		"1", "Number of orcrists to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponHelmssting			= CreateConVar( "l4d2_MITSR_Helmssting",		"1", "Number of stings to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponHelmsswordshield	= CreateConVar( "l4d2_MITSR_Helmsswordshield",	"1", "Number of warrior sets to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponHylianshield		= CreateConVar( "l4d2_MITSR_Hylianshield",		"1", "Number of hylian shields to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponIaxe			    = CreateConVar( "l4d2_MITSR_Iaxe",				"1", "Number of iron axes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponIhoe			    = CreateConVar( "l4d2_MITSR_Ihoe",				"1", "Number of iron hoes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponIpickaxe			= CreateConVar( "l4d2_MITSR_Ipickaxe",			"1", "Number of iron pickaxes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponIsword			    = CreateConVar( "l4d2_MITSR_Isword",			"1", "Number of iron swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponKatana2			= CreateConVar( "l4d2_MITSR_Katana2",			"1", "Number of skyrim katanas to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponKitchenknife		= CreateConVar( "l4d2_MITSR_Kitchenknife",		"1", "Number of kitchen knives to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponLamp			    = CreateConVar( "l4d2_MITSR_Lamp",				"1", "Number of lamps to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponLegosword			= CreateConVar( "l4d2_MITSR_Legosword",			"1", "Number of lego swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponLightsaber			= CreateConVar( "l4d2_MITSR_Lightsaber",		"1", "Number of lightsabers to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponLobo			    = CreateConVar( "l4d2_MITSR_Lobo",				"1", "Number of palm daggers to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponLongsword			= CreateConVar( "l4d2_MITSR_Longsword",			"1", "Number of swords and shields to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponM72law			    = CreateConVar( "l4d2_MITSR_M72law",			"1", "Number of m72 laws to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponMace			    = CreateConVar( "l4d2_MITSR_Mace",				"1", "Number of maces to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponMace2			    = CreateConVar( "l4d2_MITSR_Mace2",				"1", "Number of improved maces to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponMastersword		= CreateConVar( "l4d2_MITSR_Mastersword",		"1", "Number of master swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponMirrorshield		= CreateConVar( "l4d2_MITSR_Mirrorshield",		"1", "Number of mirror shields to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponMop			    = CreateConVar( "l4d2_MITSR_Mop",				"1", "Number of light blue mops to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponMop2			    = CreateConVar( "l4d2_MITSR_Mop2",				"1", "Number of pink mops to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponMuffler			= CreateConVar( "l4d2_MITSR_Muffler",			"1", "Number of mufflers to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponNailbat			= CreateConVar( "l4d2_MITSR_Nailbat",			"1", "Number of nail bats to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponPickaxe			= CreateConVar( "l4d2_MITSR_Pickaxe",			"1", "Number of pickaxes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponPipehammer			= CreateConVar( "l4d2_MITSR_Pipehammer",		"1", "Number of pipe hammers to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponPot			    = CreateConVar( "l4d2_MITSR_Pot",				"1", "Number of sauce pots to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponRiotshield			= CreateConVar( "l4d2_MITSR_Riotshield",		"1", "Number of riotshields to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponRockaxe			= CreateConVar( "l4d2_MITSR_Rockaxe",			"1", "Number of rockaxes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponScup			    = CreateConVar( "l4d2_MITSR_Scup",				"1", "Number of pink mugs to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponSh2wood			= CreateConVar( "l4d2_MITSR_Sh2wood",			"1", "Number of nail sticks to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponShoe			    = CreateConVar( "l4d2_MITSR_Shoe",				"1", "Number of silver hoes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponSlasher			= CreateConVar( "l4d2_MITSR_Slasher",			"1", "Number of slasher blades to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponSpickaxe			= CreateConVar( "l4d2_MITSR_Spickaxe",			"1", "Number of silver pickaxes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponSshovel			= CreateConVar( "l4d2_MITSR_Sshovel",			"1", "Number of silver shovels to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponSsword			    = CreateConVar( "l4d2_MITSR_Ssword",			"1", "Number of silver swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponSyringegun			= CreateConVar( "l4d2_MITSR_Syringegun",		"1", "Number of syringe guns to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponThrower			= CreateConVar( "l4d2_MITSR_Thrower",			"1", "Number of improved makeshift flamethrowers to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponTireiron			= CreateConVar( "l4d2_MITSR_Tireiron",			"1", "Number of tire irons to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponTonfariot			= CreateConVar( "l4d2_MITSR_Tonfariot",			"1", "Number of tonfas and riotshields to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponTrashbin			= CreateConVar( "l4d2_MITSR_Trashbin",			"1", "Number of trash cans to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponVampiresword		= CreateConVar( "l4d2_MITSR_Vampiresword",		"1", "Number of vampire swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWand			    = CreateConVar( "l4d2_MITSR_Wand",				"1", "Number of magic wands to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWaterpipe			= CreateConVar( "l4d2_MITSR_Waterpipe",			"1", "Number of water pipes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWaxe			    = CreateConVar( "l4d2_MITSR_Waxe",				"1", "Number of wooden axes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWeaponchalice		= CreateConVar( "l4d2_MITSR_Weaponchalice",		"1", "Number of chalices to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWeaponmorgenstern	= CreateConVar( "l4d2_MITSR_Weaponmorgenstern",	"1", "Number of flail maces to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWeaponshadowhand	= CreateConVar( "l4d2_MITSR_Weaponshadowhand",	"1", "Number of shadow claws to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWeaponsof			= CreateConVar( "l4d2_MITSR_Weaponsof",			"1", "Number of molten swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWoodbat			= CreateConVar( "l4d2_MITSR_Woodbat",			"1", "Number of wooden bats to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWpickaxe			= CreateConVar( "l4d2_MITSR_Wpickaxe",			"1", "Number of wooden pickaxes to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWrench			    = CreateConVar( "l4d2_MITSR_Wrench",			"1", "Number of wrenches to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWshovel			= CreateConVar( "l4d2_MITSR_Wshovel",			"1", "Number of wooden shovels to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWsword			    = CreateConVar( "l4d2_MITSR_Wsword",			"1", "Number of wooden swords to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
	g_hWeaponWulinmiji			= CreateConVar( "l4d2_MITSR_Wulinmiji",			"1", "Number of wulinmijis to spawn (l4d2_MITSR_Random must be 0)", FCVAR_NONE );
