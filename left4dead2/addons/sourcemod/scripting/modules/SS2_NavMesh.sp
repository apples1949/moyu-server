...
NavMesh_OnModuleStart()
{
	...
	hCVarRearSpawnMaxTrailingDistance = CreateConVar("ss2_rearspawn_max_trailing_distance", "150", "Limit set on ", 0, true, 0.0);
...
{
	return false;
	/** TODO: Function is returning too many false positives; almost no spawns
    bool isStuck = false;
