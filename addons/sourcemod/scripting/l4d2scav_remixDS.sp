...
public void OnPluginStart()
{
	...
	g_hGasCanCount = CreateConVar("l4d2_scramble_can_count", "32", "Value = How many Gas Cans to spawn from the pool.", FCVAR_NOTIFY);
	g_hScavengeGasCanCount = CreateConVar("l4d2_scavenge_scramble_can_count", "32", "Value = How many Gas Cans to spawn from the pool in Scavenge mode.", FCVAR_NOTIFY);
...
//We also spawn once the cans at the RoundReadyup Event (maybe we can skip the BeginScavenge Event? Letz see)
