...
public OnPluginStart()
{
	...
	H_RestoreEnabled[1] = CreateConVar("l4d2_ghost_hp_restore_smoker", "1", "Is smoker health restore enabled", FCVAR_SS_ADDED|FCVAR_NOTIFY,true,0.0,true,1.0);
	H_RestoreEnabled[2] = CreateConVar("l4d2_ghost_hp_restore_boomer", "1", "Is boomer health restore enabled", FCVAR_SS_ADDED|FCVAR_NOTIFY,true,0.0,true,1.0);
	H_RestoreEnabled[3] = CreateConVar("l4d2_ghost_hp_restore_hunter", "1", "Is huter health restore enabled", FCVAR_SS_ADDED|FCVAR_NOTIFY,true,0.0,true,1.0);
	H_RestoreEnabled[4] = CreateConVar("l4d2_ghost_hp_restore_spitter", "1", "Is spitter health restore enabled", FCVAR_SS_ADDED|FCVAR_NOTIFY,true,0.0,true,1.0);
	H_RestoreEnabled[5] = CreateConVar("l4d2_ghost_hp_restore_jockey", "1", "Is jockey health restore enabled", FCVAR_SS_ADDED|FCVAR_NOTIFY,true,0.0,true,1.0);
	H_RestoreEnabled[6] = CreateConVar("l4d2_ghost_hp_restore_charger", "1", "Is charger health restore enabled", FCVAR_SS_ADDED|FCVAR_NOTIFY,true,0.0,true,1.0);
	CreateConVar("l4d2_ghost_hp_restore_version", PLUGIN_VERSION, "Left 4 Dead 2 Ghost HP Restore version", FCVAR_SS_ADDED|FCVAR_REPLICATED|FCVAR_DONTRECORD);
