...
public void OnPluginStart()
{
    ...
    cPrintToChat = CreateConVar("sm_vocalize_guard_print_to_chat", "0", "Print notice message to the chat?", FCVAR_NOTIFY, true, 0.0, true, 1.0);
...
public Action Command_CallVocal(int client, int args)
{
    ...
    int iPrint = cPrintToChat.IntValue;
